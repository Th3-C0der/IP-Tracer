...
# Green ASCII art
echo -e "\e[32m  _ ____     _____                        "
echo -e "\e[32m (_)  _ \   |_   _| __ __ _  ___ ___ _ __ "
echo -e "\e[32m | | |_) |____| || '__/ _\` |/ __/ _ \ '__|"
echo -e "\e[32m | |  __/_____| || | | (_| | (_|  __/ |   "
echo -e "\e[32m |_|_|        |_||_|  \__,_|\___\___|_|   "
...
function About() {
  ...
  echo <<<EOL
         ...
         \033[01;33mAuthor \033[01;37m:- \033[01;36mTh3-C0der
...
function upd() {
  ...
  sleep(1);
  system("cd ~/ && git clone https://github.com/Th3-C0der/IP-Tracer.git");
  system("cd ~/ && sudo git clone https://github.com/Th3-C0der/IP-Tracer.git");
